                        ...
                        <div class="col-sm-4 offset-md-1 py-4">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle text-white font-weight-bold uppercase" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                ...
                <div class="container d-flex justify-content-between">
                    <a href="{{ url('/') }}" class="navbar-brand d-flex align-items-center">
                        ...
                        <strong class="font-weight-bold">
                            ...
                            {{ config('Mini Youtube', 'Mini Youtube') }}
                            <!-- </a> -->
                        </strong>
                    </a>
